...
function ScreenNivelAutonomia() {
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.buttonText}>Quase lá!</Text>

      <Text style={styles.buttonText}>Você  pode alcançar melhores resultados, gerenciando seu trabalho e utilizando seu conhecimento técnico. Crie metas, mantenha o diálogo equilibrado com a equipe de saúde e segurança e continue confiando no êxito do seu trabalho</Text>
    </View>
  );
}
