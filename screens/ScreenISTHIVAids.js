...
function ScreenISTHIVAids() {
  return (
    <View style={styles.container}>
      ...
      <Image
        source={require("../assets/imagem/Tela12_2.png")} // Caminho para a imagem do botão
        style={styles.imagem}
      />

      <Image
        source={require("../assets/imagem/Tela12_3.png")} // Caminho para a imagem do botão
        style={styles.imagem}
      /> */}
...
export default ScreenISTHIVAids;
