...
export default function ScreenTuberculose() {
  return (
    <View style={styles.container}>
      <Text style={styles.buttonText}>Tuberculose</Text>
      <Image
        source={require("../assets/imagem/Tela11_1.png")} // Caminho para a imagem do botão
        style={styles.imagem}
      />

      <Image
        source={require("../assets/imagem/Tela11_2.png")} // Caminho para a imagem do botão
        style={styles.imagem}
      />
